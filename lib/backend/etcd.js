...
// Create Super Object
var _super = require('../backend.js').prototype;
...
function ETCDBackend(opts){
    ...
    this.etcd.get(this.etcd_dir,function(err, body, header){
      if (err && err.errorCode == 100){
        ...
        cb(new Error('ETCD Backend Error'));
      }
    }
